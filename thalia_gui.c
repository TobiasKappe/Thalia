...
static void thalia_gui_update_key(guint16 keyval, gboolean value)
{
	...
	switch(keyval) {
		...
		case GDK_Left:
			...
			break;
		case GDK_z: gb->keypad.key_a = value; break;
		case GDK_x: gb->keypad.key_b = value; break;
		case GDK_Return: gb->keypad.key_start = value; break;
		case GDK_BackSpace: gb->keypad.key_select = value; break;
	}
