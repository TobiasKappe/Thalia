...
static void thalia_gb_init(ThaliaGB* gb)
{
	...
	// Create a pixel buffer for us to blit pixels in, start with a black screen
...
void thalia_gb_run(ThaliaGB* gb)
{
	while(TRUE) {
		...
		// TODO: Slow down execution to real-time speed taking the amount of cycles
		// used for each instruction into account, with optional throttle.
	}
}
